Scaling [myawesometmlproject-9538-agenticai] With Kubernetes
===========================
...
Based on your TML solution [myawesometmlproject-9538-agenticai] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`myawesometmlproject-9538-agenticai.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-myawesometmlproject-9538-agenticai.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingressmyawesometmlproject-9538-agenticai.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f myawesometmlproject-9538-agenticai.yml -f ollama.yml

myawesometmlproject-9538-agenticai.yml
------------------------

.. important::
   Copy and Paste this YAML file: myawesometmlproject-9538-agenticai.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/Bobbie101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlproject-9538/ymls/myawesometmlproject-9538-agenticai
...
.. code-block:: YAML
   ...
   ################# myawesometmlproject-9538-agenticai.yml
     ...
     kind: Deployment
     metadata:
       name: myawesometmlproject-9538-agenticai
     spec:
       selector:
         matchLabels:
           app: myawesometmlproject-9538-agenticai
       ...
       template:
         ...
         spec:
           containers:
           - name: myawesometmlproject-9538-agenticai
             image: Bobbie101/myawesometmlproject-9538-agenticai-arm64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: PROJECTNAME
               value: 'myawesometmlproject-9538'                              
             - name: SOLUTIONNAME
               value: 'myawesometmlproject-9538-agenticai'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_agenticai_dag-myawesometmlproject-9538'
             - name: GITUSERNAME
               value: 'Bobbie101'
             - name: GITREPOURL
   ...
   ---
     ...
     kind: Service
     metadata:
       name: myawesometmlproject-9538-agenticai-visualization-service
       labels:
         app: myawesometmlproject-9538-agenticai-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlproject-9538-agenticai 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-myawesometmlproject-9538-agenticai.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-myawesometmlproject-9538-agenticai.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-myawesometmlproject-9538-agenticai.yml
