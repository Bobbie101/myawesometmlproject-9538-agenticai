[myawesometmlproject-9538-agenticai] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlproject-9538-agenticai] container is NOT running**.

.. tip::
   You must have your [myawesometmlproject-9538-agenticai] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=4040  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/Bobbie101/raspberrypi.git  \-\-env CHIP=arm64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39399  \-\-env VIPERVIZPORT=6060  \-\-env GITUSERNAME='Bobbie101'  \-\-env DOCKERUSERNAME='Bobbie101'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-arm64
...
.. important::
   Refer to the original solution container and documenation here: https://myawesometmlproject-9538-agenticai.readthedocs.io/en/latest/operating.html
...
.. code-block::
   ...
   docker run -d --net=host -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=myawesometmlproject-9538-agenticai \
          --env SOLUTIONDAG=solution_preprocessing_agenticai_dag-myawesometmlproject-9538 \
          ...
          Bobbie101/myawesometmlproject-9538-agenticai-arm64
...
[myawesometmlproject-9538-agenticai] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Bobbie101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlproject-9538
...
.. important::
   solution_preprocessing_agenticai_dag-myawesometmlproject-9538
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=44969, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=41315, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=45189, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=46701, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=34535, HPDEHOST=172.17.0.2, HPDEPORT=37305, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=34987

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5229-myawesometmlproject-9538-agenticai,solution_preprocessing_agenticai_dag-myawesometmlproject-9538, python-preprocess-8953-myawesometmlproject-9538-agenticai,solution_preprocessing_agenticai_dag-myawesometmlproject-9538, python-agenticai-7896-myawesometmlproject-9538-agenticai,solution_preprocessing_agenticai_dag-myawesometmlproject-9538, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
